...
# Файл с данными товаров
PRODUCTS_FILE = "/workspace/data/products.json"
...
app.mount("/admin", StaticFiles(directory="/workspace/public/admin", html=True), name="admin")

# Монтирование документации API
app.mount("/docs", StaticFiles(directory="/workspace/docs", html=True), name="docs")
